...
# employee 테이블에서 모든사원의 사번, 이름, 급여를 조회
select emp_id, emp_name, salary from employee;
#급여가 300만원 이상인 사원들의 이름과 급여를 조회하시오
...
from employee;
# 2. employee 테이블에서 연봉이 3천만원 이상인 직원들의 이름과 급여조회
select emp_name, salary
from employee
...
#실습
#1. employee 테이블 에서 D5부서 이면서 급여가 300만원 이상인 직원의 이름, 연봉, 보너스를 추가한 연봉을 조회하세요
#연봉의 별칭은 연봉 보너스를 포함한 연봉의 별칭인 [총 연봉]으로 합니다
#총 연봉에 null 은신경 쓰지 말기
